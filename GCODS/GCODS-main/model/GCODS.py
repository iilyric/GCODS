...
class ODEBlock(nn.Module):
    def __init__(self,
                ...
                width,
                num_afno_blocks,
                use_mcdp_net, gcn_depth, mcdp_dropout, 
                mcdp_alpha, mcdp_beta, mcdp_gamma, 
...
class GCODS(nn.Module):
    def __init__(self, args, edge_index):
        ...
        if args.use_mcdp_net:
            gcn_depth = args.gcn_depth
            mcdp_dropout = args.mcdp_dropout
            mcdp_alpha = args.mcdp_alpha
            mcdp_beta = args.mcdp_beta
            mcdp_gamma = args.mcdp_gamma
        ...
        self.ode_block = ODEBlock(
            ...
            args.num_afno_blocks, args.use_mcdp_net, gcn_depth, 
            mcdp_dropout, mcdp_alpha, mcdp_beta, 
            mcdp_gamma, node_dim, hyperGNN_dim,
